ARCH_CFLAGS=-DDISABLE_FUNCHOOK -DDISABLE_COREDUMP
ARCH_LD_FLAGS=-lcapstone
ARCH_BINARY=elf64-littleriscv
ARCH_OBJ=$(ARCH)

LD_FLAGS=$(MUSL_AR) $(UNWIND_AR) $(PCRE2_AR) $(LS_HPACK_AR) $(YAML_AR) $(JSON_AR) -ldl -lpthread -lrt -lresolv -lz -Lcontrib/build/funchook/capstone_src-prefix/src/capstone_src-build -lcapstone -z noexecstack
