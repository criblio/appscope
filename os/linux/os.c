...
struct sigUserStruct {
    ...
    bool scopeHandlerActive;    // State of Scope Signal Handler
};
...
/*
* Check if AppScope Handler is enabled
*/
bool
...
osCallAppSigaction(int sig, siginfo_t *info, void *secret) {
    ...
    /*
    * Determine if signal info originates from AppScope timer
    */
    if (!info) {
        goto callAppaction;
    }
    ...
    if (info->si_int != SIG_ORIGIN_SCOPE_ID) {
        goto callAppaction;
    }
...
/*
* Register the signal handler for Appscope and starts the signal timer.
