    ...
    while ((getline(&line, &len, fp) != -1) && (loopcnt < MAXLINES)) {
        if (strstr(line, "net.dns") != NULL) {
            ...
            if ((key = strstr(line, "domain:")) != NULL) {
                if ((value = index(key, ':')) == NULL)
                    break;
                value += 1;
                if ((end = index(value, ',')) == NULL)
                    break;
                *end = '\0';
                // printf("%s:%d %s\n", __FUNCTION__, __LINE__, value);
                if (!domain || (strncmp(value, domain, strlen(value)) == 0))
                    rc = 0;
                break;
            }
        }
...
getDNSNameBadRequest(void **state)
{
    ...
    assert_int_not_equal(-1, fd);
    uint8_t pkt[] = {
        0x17, 0x03, 0x03, 0x00, 0x29, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x09, 0x98, 0xe0, 0x1a, 0x49, 0x88, 0xcc, 0xae, 0x5e, 0xdd, 0x57, 0x21,
        0x0d, 0xab, 0x3d, 0xd6, 0x44, 0x57, 0x64, 0x5c, 0x08, 0x91, 0x7a, 0xd2, 0x5e, 0x7d, 0x3b, 0x96, 0x2c, 0x60, 0xce, 0x71, 0x96, 0x08, 0xc0, 0x29,
    };
...
getDNSNameMaxDomainLen(void **state)
{
    ...
    int fd = createSocket(&sa);
    assert_int_not_equal(-1, fd);
    uint8_t pkt[] = {};
    assert_int_not_equal(-1, sendToNS(fd, (char *)&pkt, sizeof(pkt), &sa, 0));
    assert_int_not_equal(-1,
                         checkMetric("aaaaaaaaaaaaaaa.bbbbbbbbbbbbbbb.ccccccccccccccc.ddddddddddddddd."
...
main(int argc, char *argv[])
{
    ...
    const struct CMUnitTest tests[] = {
        cmocka_unit_test(dnsReply),  cmocka_unit_test(dnsName),          cmocka_unit_test(getDNSNameBadRequest), cmocka_unit_test(getDNSNameMaxDomainLen),
        cmocka_unit_test(dnsNoName), cmocka_unit_test(dnsGethostbyname), cmocka_unit_test(dnsGethostbyname2),    cmocka_unit_test(dnsGetaddrinfo),
    };
