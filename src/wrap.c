...
"        Not a proper env varible: this only works as a command in a \n"
...
"        If the SCOPE_CONF_PATH env variable is defined and the file it\n"
"        points to a file that can be opened, it will use this as the\n"
"        config file.  If not, it searches config file in this priority\n"
"        order using the first it finds.  If this fails too, it will look\n"
