...
- **Fix**: [#264](https://github.com/criblio/appscope/issues/264),[#565](https://github.com/criblio/appscope/issues/565) `scope k8s` now (1) supports specifying the namespace to install into, and (2) when the [ConfigMap](https://kubernetes.io/docs/concepts/configuration/configmap/) in that namespace is edited, automatically propagates edits the changes to all namespaces instrumented with the label `scope=enabled`.
