...
#define CFG_MAX_VERBOSITY 12
#define CFG_FS_EVENTS_VERBOSITY 10
#define CFG_NET_EVENTS_VERBOSITY 11
#define CFG_NET_FS_EVENTS_VERBOSITY 12
...
#define DEFAULT_OUT_VERBOSITY CFG_MAX_VERBOSITY
