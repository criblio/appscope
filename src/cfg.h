...
unsigned            cfgTransportValidateServer(config_t *, which_transport_t);
const char*         cfgTransportCACertPath(config_t *, which_transport_t);
...
void                cfgTransportValidateServerSet(config_t *, which_transport_t, unsigned);
void                cfgTransportCACertPathSet(config_t *, which_transport_t, const char *);
