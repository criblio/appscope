...
#define STRFIELD(n, v, c, e)         \
    {                                \
        n, FMT_STR, e, {.str = v}, c \
    }
#define NUMFIELD(n, v, c, e)         \
    {                                \
        n, FMT_NUM, e, {.num = v}, c \
    }
#define FIELDEND                            \
    {                                       \
        NULL, FMT_END, FALSE, {.num = 0}, 0 \
    }
...
#define INT_EVENT(n, v, t, f)                            \
    {                                                    \
        n, {FMT_INT, .integer = v}, t, f, CFG_SRC_METRIC \
    }
#define FLT_EVENT(n, v, t, f)                             \
    {                                                     \
        n, {FMT_FLT, .floating = v}, t, f, CFG_SRC_METRIC \
    }
